...
getContractFactory(name: 'PrudhvirajToken', signerOrOptions?: ethers.Signer | FactoryOptions): Promise<Contracts.PrudhvirajToken__factory>

  getContractAt(name: 'Counter', address: string | ethers.Addressable, signer?: ethers.Signer): Promise<Contracts.Counter>
getContractAt(name: 'PrudhvirajToken', address: string | ethers.Addressable, signer?: ethers.Signer): Promise<Contracts.PrudhvirajToken>

  deployContract(name: 'Counter', signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.Counter>
deployContract(name: 'PrudhvirajToken', signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.PrudhvirajToken>

  deployContract(name: 'Counter', args: any[], signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.Counter>
deployContract(name: 'PrudhvirajToken', args: any[], signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.PrudhvirajToken>
